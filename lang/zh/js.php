...
return [
    ...
    'gemini_key' => 'Gemini API 密钥字段为必填项。',
    'gemini_model' => 'Gemini 模型字段为必填项。',
    'are_you_sure_want_to_delete_selected_Organization' => '您确定要删除所选的组织吗？',
    'gallery_category' => '图库分类',
    'search_icon' => '搜索图标',
    'maximum_4_images' => '请最多上传 4 张图片。',
    'at_least_one_image' => '请至少上传一张图片。',
    'please_upload_valid_image' => '请上传有效的图片。',
    'default_plan' => '默认套餐',
];
