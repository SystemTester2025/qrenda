...
class BusinessDirectoryList3 extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.business-directory-list3', ['businesses' => $paginatedBusinesses, 'templateNames' => $this->templateNames, 'wpTemplateNames' => $this->wpTemplateNames,]);
    }
}
