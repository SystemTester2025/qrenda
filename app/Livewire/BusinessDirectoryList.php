...
class BusinessDirectoryList extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.business-directory-list', ['businesses' => $paginatedBusinesses, 'templateNames' => $this->templateNames, 'wpTemplateNames' => $this->wpTemplateNames,]);
    }
}
