    ...
    <div class="main-content mx-auto w-100 d-flex flex-column justify-content-between position-relative">
        <div>
            ...
            @if(!empty($whatsappStore->store_announcement))
                <div class="store-announcement mt-1">
            ...
            @endif
                ...
                @if ($whatsappStore->trendingVideo->count() > 0)
                    <div class="trending-videos-section">
                        <div class="text-center">
                            <h2 class="text-center text-white fs-28 fw-semibold mb-40 section-heading position-relative d-inline-block">{{ __('messages.whatsapp_stores.our_trending_videos') }}</h2>
                        </div>
