                ...
                <div class="row overflow-auto">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="table-details d-flex flex-column h-100 justify-content-between">
                            ...
                            <div class="mb-15">
                                <p class="fs-18 text-black text-end fw-5 mb-0 py-1 total" >{{ __('messages.nfc.total') }} : <span id="subTotal">0</span> </p>
                                @if (!empty($whatsappStore->discount))
                                    <input type="hidden" id="storeDiscount" value="{{ $whatsappStore->discount }}">
                                    <p class="fs-18 text-black text-end fw-5 mb-0 pt-3">- {{ __('messages.whatsapp_stores.discount') }} : <span id="discountPercentage">0</span> </p>
                                @endif
                                <p class="fs-20 text-black text-end fw-5 mb-0 py-3" >{{ __('messages.whatsapp_stores.grand_total') }} : <span id="grandTotal">0</span> </p>
