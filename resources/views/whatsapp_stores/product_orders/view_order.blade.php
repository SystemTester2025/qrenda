    ...
    <div class="modal-dialog modal-lg ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-2 table-responsive table-striped">
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" class="text-end">{{ __('messages.nfc.total') }}:</td>
                                <td id="orderSubTotal" class="fw-bold"></td>
                            </tr>
                            <tr class="discount-row">
                                <td colspan="4" class="text-end">{{ __('messages.whatsapp_stores.discount') }}:</td>
                                <td id="orderDiscount" class="fw-bold"></td>
                            </tr>
                            <tr>
