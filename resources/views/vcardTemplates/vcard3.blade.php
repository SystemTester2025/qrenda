    ...
    <div class="container p-0">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="vcard-three__gallery mt-3 position-relative px-3 mt-0 pb-9">
                        ...
                        @if ($groupedGallery->isNotEmpty())
                            <div class="gallery-filter-nav d-flex flex-wrap justify-content-center gap-2 mb-25px mb-2 pt-3 pb-2">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (!qrCodeThree || !link) return;

                const img = qrCodeThree.querySelector("img");
