...
<body>
    <div class="container p-0">
        ...
        <div
            ...
            <div class="vcard-ten__banner w-100 position-relative px-2">
                ...
                @endif
                <div class="d-flex justify-content-end position-absolute top-0 end-0 mx-3 language-btn ms-5">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!qrCodeTen || !link) return;

            const img = qrCodeTen.querySelector("img");
