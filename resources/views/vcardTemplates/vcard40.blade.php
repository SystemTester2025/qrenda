...
<body>
    ...
    <div class="main-content {{ (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') ? 'rtl' : '' }}">
        ...
        <div class="profile-section @if ($vcard->cover_type == 2)  @endif"
            ...
            <div class="position-relative">
                <div class="profile-top-section px-30 text-center">
                    <div class="profile mx-auto mb-3">
                    ...
                    <div class="profile-name">
                        ...
                        <p class="profile-desc mb-0 fw-5 fs-14">{{ ucwords($vcard->occupation) }}</p>
                        <p class="profile-desc mb-0 fw-5 fs-14">{{ ucwords($vcard->job_title) }}</p>
                    </div>
                    {{-- social-media --}}
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div class="scial-icons-section pt-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="description px-30 text-center fs-14 fw-normal text-primary pt-4">
                <p class="text-center">
                    {!! $vcard->description !!}
                </p>
            </div>
        ...
        @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
            @if (
                ...
                <div class="contact-section pt-50 px-30">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/contact-title.svg') }}" alt="" />
                        {{ __('messages.dynamic_vcard.contact') }}
                    </h5>
                    <div class="row row-gap-20 text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($vcard->email)
                            <div class="col-sm-6">
                                <div class="contact-box">
                                    <div class="contact-icon">
                                        <img src="{{ asset('assets/img/vcard40/mail.svg') }}" alt="img" />
                                    </div>
                                    <a href="mailto:{{ $vcard->email }} class="pt-1
                                        text-break"">{{ $vcard->email }}</a>
                                </div>
                            </div>
                        @endif
                        @if ($vcard->alternative_email)
                            <div class="col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <a href="mailto:{{ $vcard->alternative_email }} class="pt-1
                                        text-break"">{{ $vcard->alternative_email }}</a>
                                </div>
                            </div>
                        @endif
                        @if ($vcard->phone)
                            <div class="col-sm-6">
                                <div class="contact-box">
                                    <div class="contact-icon">
                                        <img src="{{ asset('assets/img/vcard40/phone.svg') }}" alt="img" />
                                    </div>
                                    <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                        class="pt-1 text-break">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="col-sm-6">
                                <div class="contact-box">
                                    <div class="contact-icon">
                                        ...
                                        @else
                                            <img src="{{ asset('assets/img/vcard40/dob.svg') }}" alt="img" />
                                        @endif
                                    </div>
                                    <p>{{ $vcard->dob }}</p>
                                </div>
                        ...
                        @if ($vcard->location)
                            <div class="col-sm-6">
                                <div class="contact-box">
                                    <div class="contact-icon">
                                        <img src="{{ asset('assets/img/vcard40/location.svg') }}" alt="img" />
                                    </div>
        ...
        @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
            @if (checkFeature('gallery') && $vcard->gallery->count())
                <div class="gallery-section pt-50 px-20">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/gallery-title.svg') }}" alt="img" />
        ...
        @if ((isset($managesection) && $managesection['services']) || empty($managesection))
            @if (checkFeature('services') && $vcard->services->count())
                <div class="service-section pt-30 px-20">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/service-title.svg') }}" alt="img" />
                                ...
                                <div class="service-card">
                                    ...
                                    <div class="service-content">
                                        <div>
                                            ...
                                            <p class="description-text mb-2 fs-14">
                                                {{ $service->description }}
                                            </p>
                                        </div>
        ...
        @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
            @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                <div class="appointment-section pt-50 px-20">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/appointment-title.svg') }}" alt="img" />
        ...
        @if ((isset($managesection) && $managesection['products']) || empty($managesection))
            @if (checkFeature('products') && $vcard->products->count())
                <div class="product-section pt-50 px-20 position-relative">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/product-title.svg') }}" alt="img" />
                            ...
                            <div class="product-card">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="product-content">
                                        <h3 class="card-title text-primary text-center">{{ $product->name }}</h3>
                                        <div
                                            ...
                                            <p class="product-amount mb-0">
                                                @if ($product->currency_id && $product->price)
                                                    <span
                                                        class="price text-primary">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                @elseif($product->price)
                                                    <span
                                                        class="price text-primary">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                @endif
                                            </p>
                    ...
                    <div class="product-bottom-img">
                        <img src="{{ asset('assets/img/vcard40/bottom-img.png') }}" alt="img"
                            class="w-100 h-100" />
                    </div>
                </div>
            @endif
        ...
        @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
            @if ($whatsappStore->count())
                <div class="whatsapp-store-section position-relative pt-60 px-20">

                    <div class="title d-flex align-items-center gap-20 justify-content-center">
                        <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                            <img src="{{ asset('assets/img/vcard40/whatsapp-title.svg') }}" alt="img" />
        ...
        @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
            @if (checkFeature('testimonials') && $vcard->testimonials->count())
                <div class="testmonial-section px-20">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/testimonial-title.svg') }}" alt="img" />
                            ...
                            <div>
                                <div class="testimonial-card">
                                    <div class="testimonial-bg">
                                        <div class="d-flex align-items-center gap-4 mb-2 justify-content-center">
                                            <span class="testimonial-img">
                                                <img src="{{ $testimonial->image_url }}" alt="img"
                                                    class="w-100 h-100 object-fit-cover rounded-circle" />
                                            </span>
                                            <h6 class="fs-22">{{ $testimonial->name }}</h6>
                                        </div>
                                        <div class="testimonial-desc">
                                            <p>
                                                {{ $testimonial->description }}
                                            </p>
                                            <img src="{{ asset('assets/img/vcard40/quote-left.svg') }}"
                                                alt="img" class="quote-img quote-left" />
                                            <img src="{{ asset('assets/img/vcard40/quote-right.svg') }}"
                                                alt="img" class="quote-img quote-right" />
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
            @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                <div class="pt-60 position-relative px-20">
                    <div class="title d-flex align-items-center gap-20 justify-content-center">
                        <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                            <img src="{{ asset('assets/img/vcard40/instafeed-title.svg') }}" alt="img" />
        ...
        @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
            @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                <div class="pt-5">
                    <div class="title d-flex align-items-center gap-20 justify-content-center">
                        <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                            <img src="{{ asset('assets/img/vcard40/linkedin-title.svg') }}" alt="img" />
        ...
        @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
            @if (checkFeature('blog') && $vcard->blogs->count())
                <div class="blog-section pt-50 px-20 position-relative">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/blog-title.svg') }}" alt="img" />
                            ...
                            <div>
                                <div class="blog-card">
                                    ...
                                    <div class="blog-content" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <a href="{{ $vcardBlogUrl }}">
                                            <h3
                                                class="text-primary mb-2 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-end @endif">
                                                {{ $blog->title }}
                                            </h3>

                                            <p
                                                class="text-primary @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-end @endif">
                                        ...
                                        <div class="read-more">
                                            <a href="{{ $vcardBlogUrl }}"
                                                class="read-more read-more-border button-primary max-w-fit ms-auto py-1 px-2">
        ...
        @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
            @if ($vcard->businessHours->count())
                <div class="business-hour-section pt-50 px-30">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/business-title.svg') }}" alt="img" />
                        {{ __('messages.business.business_hours') }}
                    </h5>
                    <div class="row row-gap-20 business-cards justify-content-center">
                        @foreach ($businessDaysTime as $key => $dayTime)
                            <div class="col-sm-6">
                                <div class="business-box text-center">
                                    <span class="calender-img">
                                        <img src="{{ asset('assets/img/vcard40/calender.svg') }}" alt="img"
                                            class="pb-1" />
                                    </span>
                                    <h3 class="fs-16">
        ...
        @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
            <div class="qr-code-section pt-50 px-30">
                <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                    <img src="{{ asset('assets/img/vcard40/qr-title.svg') }}" alt="img" />
                    {{ __('messages.vcard.qr_code') }}
                </h5>
                <div class="qr-code-box d-flex align-items-center gap-3 flex-column flex-sm-row text-sm-start text-center @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @else text-sm-start @endif"
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="qr-img d-flex align-items-center justify-content-center" id="qr-code-fourty">
                        @php
                            $qrMedia = $vcard->getMedia(\App\Models\Vcard::QRCODE_PATH)->first();
                        @endphp

                        @if ($qrMedia)
                            <img src="{{ $qrMedia->getUrl() }}" alt="QR Code" width="110" height="110" />
                        @else
                    ...
                    <div class="qr-content">
                        <h3 class="fs-20 pb-2">{{ __('messages.vcard.scan_to_contact') }}</h3>
                        <p class="fs-16">{{ __('messages.vcard.qr_section_desc') }}</p>
                    </div>
                </div>
            </div>
        @endif
        ...
        @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
            @if (checkFeature('iframes') && $vcard->iframes->count())
                <div class="iframe-section pt-50 px-20">
                    <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                        <img src="{{ asset('assets/img/vcard40/iframe-title.svg') }}" alt="img" />
        ...
        @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
            @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                <div class="payment-link-section px-10 pt-40 position-relative">
                    <div class="title d-flex align-items-center gap-20 justify-content-center">
                        <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                            <img src="{{ asset('assets/img/vcard40/paymentlink-title.svg') }}" alt="img" />
                            ...
                            <div class="slide px-2 py-4">
                                <div class="pl-strip">
                                    ...
                                    <div class="pl-strip-content">
                                        <h4 class="pl-strip-title">{{ Illuminate\Support\Str::limit($paymentLink->label, 25, '...') }}</h4>
        ...
        @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
            <div class="contact-us-section pt-50 px-20 position-relative">
                <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                    <img src="{{ asset('assets/img/vcard40/mail.svg') }}" alt="img" />
                    {{ __('messages.contact_us.inquries') }}
                </h5>
                <div class="contact-form" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                <div class="mb-3">
                                    <div class="wrapper-file-input">
                                        <div class="input-box upload-file" id="fileInputTrigger">
                                            <h4 class="fs-16 fw-lighter text-center" <i class="fa-solid fa-upload me-2 text-primary"></i>{{ __('messages.choose_file') }} </h4>
        ...
        @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
            <div class="create-your-vcard px-30">
                <h5 class="section-heading text-center d-flex align-items-center gap-1 gap-sm-2 justify-content-center mb-4">
                    <img src="{{ asset('assets/img/vcard40/vcard-create.svg') }}" alt="img" />
                    {{ __('messages.create_vcard') }}
                </h5>
                <div class="cart" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="create-vcard">
        ...
        @if ((isset($managesection) && $managesection['map']) || empty($managesection))
            @if ($vcard->location_url)
                ...
                @if (isset($url[5]))
                    <div class="map-section pt-50 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="location-section bg-white">
                            <div class="d-flex gap-3 align-items-center location-name">
                                <div class="location-img">
                                    <img src="{{ asset('assets/img/vcard40/location-img.svg') }}" alt="img" />
                                </div>
                                <span>{{ $vcard->location }}</span>
                            </div>

                            <div class="map-iframe mt-4">
                    ...
                    @if (empty($vcard->hide_stickybar))
                        ...
                        <div class="sub-btn d-none">
                            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                                    ...
                                    <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                        ...
                                        <div class="share-wp-btn-div">
                                            <a href="javascript:void(0)"
                                                class="vcard40-sticky-btn vcard40-btn-group d-flex justify-content-center align-items-center rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
                                ...
                                @if (empty($vcard->hide_stickybar))
                                    <div
                                        class="{{ isset($vcard->whatsapp_share) ? 'vcard40-btn-group' : 'stickyIcon' }}">
                                        <button type="button"
                                            class="vcard40-btn-group vcard40-share vcard40-sticky-btn mb-3"><i
                                                class="fas fa-share-alt fs-4 pt-1"></i></button>
                                        @if($vcard->show_qr_code)
                                            @if (!empty($vcard->enable_download_qr_code))
                                                <a type="button"
                                                    class="vcard40-btn-group vcard40-sticky-btn d-flex justify-content-center no-hover align-items-center text-decoration-none px-2 mb-3 py-2"
        ...
        {{-- made by --}}
        <div class="d-flex justify-content-evenly w-100 pt-30 pb-20">
        ...
        {{-- share modal code --}}
        <div id="vcard40-shareModel" class="modal fade" role="dialog">
