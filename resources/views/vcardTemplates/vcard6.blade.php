        ...
        <div class="row d-flex justify-content-center content-blur">
                                            ...
                                            @if ($vcard->email)
                                                <div class="col-sm-6 mb-4">
                                                    <div class="card border-0 bg-transparent">
                                                        <div class="event-icon text-white d-flex align-items-start">
                                            ...
                                            @if ($vcard->dob)
                                                <div class="col-sm-6 mb-4">
                                                    <div class="card border-0 bg-transparent">
                                                        <div class="event-icon text-white d-flex align-items-start">
                                                            @if($vcard->dob_icon)
                                                                <div class="dob-icon me-3 d-inline-block"> <i class="{{ $vcard->dob_icon }}"></i> </div>
                                                            @else
            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    if (!qrCodeSix || !link) return;

                    const img = qrCodeSix.querySelector("img");
