        ...
        <div class="">
            <div class="main-bg p-0 collapse show allSection">
                ...
                <div class="head-img position-relative">
                    ...
                    @endif
                    <div class="d-flex justify-content-end position-absolute top-0 end-0 mx-3 language-btn ms-3">
                            ...
                            <div class="row">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 pb-4">
                                        <div class="about-details">
                                            @if($vcard->dob_icon)
                                                <div class="dob-icon mb-2"> <i class="{{ $vcard->dob_icon }}"></i> </div>
                                            @else
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 pb-4">
                                        <div class="about-details">
                                            ...
                                            <p class="about-title mb-0 text-break">{!! $vcard->location !!}</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
            ...
            <script>
                ...
                document.addEventListener('play', function(e) {
                    if (e.target.tagName === 'VIDEO' || e.target.tagName === 'AUDIO') {
                        let $slider = $(e.target).closest('.gallery-vcard');
                        if ($slider.length) {
                ...
                const handleMediaPause = function(target) {
                    if (target.tagName === 'VIDEO' || target.tagName === 'AUDIO') {
                        let $slider = $(target).closest('.gallery-vcard');
                        if ($slider.length) {
                ...
                $(".gallery-vcard").find(".slick-cloned a").removeAttr("data-lightbox");
                ...
                $(".gallery-filter-btn").on("click", function () {
                    ...
                    activePanel.find(".gallery-vcard").slick("setPosition");
                });
            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    if (!qrCodeFive || !link) return;

                    const img = qrCodeFive.querySelector("img");
