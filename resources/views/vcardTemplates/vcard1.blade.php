...
<body>
    <div class="container p-0">
        ...
        <div
            ...
            <div class="vcard-one__banner w-100 position-relative">
                ...
                @endif
                <div class="d-flex justify-content-end position-absolute top-0 end-0 mx-3 language-btn mx-3">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="vcard-one__gallery pt-5">
                        ...
                        @if ($groupedGallery->isNotEmpty())
                            <div class="gallery-filter-nav d-flex flex-wrap justify-content-center gap-2 mb-25px mb-2 pt-4">
                        ...
                        <div class="container">
                                                ...
                                                <div class="gallery-profile">
                                                    ...
                                                    @else
                                                        <iframe
                                                            ...
                                                            class="w-100" height="224" allowfullscreen>
                                                        </iframe>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            @foreach ($groupedGallery as $categoryName => $galleryItems)
                                <div class="gallery-filter-panel"
                                    ...
                                    <div class="gallery-slider row g-4 overflow-hidden">
                                                ...
                                                <div class="card gallery-card m-auto p-2 border-0 w-100 h-100 gallery-vcard-block">
                                                    <div class="gallery-profile">
                                                        ...
                                                        @else
                                                            <iframe
                                                                src="https://www.youtube.com/embed/{{ YoutubeID($file->link) }}"
                                                                class="w-100" height="222" allowfullscreen>
                                                            </iframe>
                                                        @endif
                                                    </div>
                                                </div>
                        ...
                        <div class="container px-4">
                            <div class="appointment-one">
                                ...
                                <div class="row d-flex align-items-center justify-content-center mb-md-3">
                                    <div class="col-md-2">
                                        <label for="hour"
                                            class="appoint-date mb-2 text-left" id="hourSection" style="display: none;">{{ __('messages.hour') }}</label>
                                    </div>
                                    <div class="col-md-10">
                    ...
                    <div class="container">
                        <form id="enquiryForm" enctype="multipart/form-data">
                            ...
                            @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                <div class="contact-form px-3 pb-4">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="submit"
                                            class="contact-btn text-white mt-4 d-block">{{ __('messages.contact_us.send_message') }}</button>
                                    </div>
                                </div>
                            @endif
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                                <div class="contact-form px-3 pb-4" dir="rtl">
                                    <div id="enquiryError" class="alert alert-danger d-none"></div>
                                    <div class="mb-3">
                                        <label class="form-label">
                                            {{ __('messages.common.name') }}<span class="text-danger">*</span></label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!qrCodeOne || !link) return;

            const img = qrCodeOne.querySelector("img");
