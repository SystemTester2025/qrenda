...
<body>
    <svg width="0" height="0" style="position: absolute;">
        <defs>
            <linearGradient id="vcard9-icon-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                ...
                                                <h5 class="event-name text-center mb-0 text-break">{!! ucwords($vcard->location) !!}</h5>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="vcard-nine__gallery px-3 position-relative px-sm-3 my-5">
                        ...
                        @if ($groupedGallery->isNotEmpty())
                            <div class="gallery-filter-nav d-flex flex-wrap justify-content-center gap-2 mb-25px mb-2 pt-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!qrCodeNine || !link) return;

            const img = qrCodeNine.querySelector("img");
