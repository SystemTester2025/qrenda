                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <a href=""
                                                    class="text-black mb-0 fs-14 fw-5 text-break">{!! ucwords($vcard->location) !!}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    @foreach ($galleryItems as $file)
                                        ...
                                        <div class="slide position-relative">
                                            <div class="gallery-img position-relative">
                                                ...
                                                @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                                    <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images-{{ \Illuminate\Support\Str::slug($categoryName, '-') }}"><img
                    ...
                    <div class="px-30">
                        ...
                        <div class="qr-code mx-auto  position-relative">
                            <div class="d-flex flex-sm-row flex-column gap-3 position-relative z-1 align-items-center"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                <div class="qr-code-img text-center" id="qr-code-nineteen">
                                    @php
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!qrCodeNineteen || !link) return;

        const img = qrCodeNineteen.querySelector("img");
