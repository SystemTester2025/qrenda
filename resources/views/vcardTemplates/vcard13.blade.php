...
<body>
                                                ...
                                                @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                    <div class="audio-container mt-2">
                                                        <img src="{{ asset('assets/img/music.jpeg') }}" alt="Album Cover"
                                                         class="audio-image">
                                                        <audio controls src="{{ $file->gallery_image }}" ="audio-control">
                    ...
                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="vcard13-sticky-btn add-contact-btn  d-flex gap-1 justify-content-center ms-0 text-white align-items-center rounded text-decoration-none  justify-content-center"><i
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!qrCodeThirteen || !link) return;

            const img = qrCodeThirteen.querySelector("img");
