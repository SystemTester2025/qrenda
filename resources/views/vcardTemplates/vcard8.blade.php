...
<body>
                                                ...
                                                <div class="contact-card">
                                                    ...
                                                    <div class="event-details">
                                                       {{-- <span
                                                        ...
                                                        <h5 class="text-center mb-0 text-white text-break">{!! ucwords($vcard->location) !!}
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="vcard-eight__gallery py-4 position-relative px-sm-4 px-3 mt-0 pb-5">
                        ...
                        @foreach ($groupedGallery as $categoryName => $galleryItems)
                            <div class="gallery-filter-panel"
                                ...
                                <div class="gallery-slider row g-3 mt-2">
                                    ...
                                    <form id="enquiryForm" enctype="multipart/form-data">
                                        ...
                                        <div class="contact-form px-sm-3">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button type="submit"
                                                    class="contact-btn text-white mt-4 rounded d-block">{{ __('messages.contact_us.send_message') }}
                                                </button>
                                            </div>
                                        </div>
                                    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!qrCodeEight || !link) return;

            const img = qrCodeEight.querySelector("img");
