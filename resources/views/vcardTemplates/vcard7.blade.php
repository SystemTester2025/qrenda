...
<body>
                                ...
                                <div class="row d-flex">
                                    <div class="col-lg-6">
                                        <div class="text-center mb-4 qr-svg-padding-10px" id="qr-code-seven">
                                            ...
                                            @if ($qrMedia)
                                                <img src="{{ $qrMedia->getUrl() }}" alt="QR Code" width="115" height="115" />
                                            @else
                                            ...
                                            <div class="card blog-card p-2 border-0 w-100 h-100">
                                              ...
                                              <div class="blog-details mt-4">
                                                    <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                                                        <h4 class="text-white mb-3 title-olor text-black">
                                                            {{ $blog->title }}
                                                        </h4>
                                                        <p class="mb-1">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!qrCodeSeven || !link) return;

            const img = qrCodeSeven.querySelector("img");
