                                                ...
                                                <div class="">
                                                    <div class="gallery-all position-relative">
                                                        ...
                                                        <a href="{{ $file->gallery_image }}"
                                                            data-lightbox="gallery-images-all" class="gallery-img"><img
                                                ...
                                                <div>
                                                    <div class="gallery-img">
                                                        <iframe id="video"
                                                            ...
                                                            class="w-100 scale-hover" height="200" allowfullscreen>
                                                        </iframe>
                                                    </div>
                                                </div>
                                            @endif
                                                ...
                                                @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                                   <div class="">
                                                        <div class="gallery-all position-relative">
                                                            ...
                                                            <a href="{{ $file->gallery_image }}"
                                                                data-lightbox="gallery-images" class="gallery-img-{{ \Illuminate\Support\Str::slug($categoryName, '-') }}"><img
                                                                    src="{{ $file->gallery_image }}" alt="profile"
                                                                    class="w-100 h-100 object-fit-contain scale-hover"
                                                                    loading="lazy" /></a>
                                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!qrCodeTwelve || !link) return;

        const img = qrCodeTwelve.querySelector("img");
