                ...
                @if (
                    ...
                    <div class="contact-section position-relative px-30 pt-50">
                        ...
                        <div class="position-relative">
                            <div class="row row-gap-50px" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                @if ($vcard->email)
                                    <div class="col-md-6">
                ...
                <div class="qr-code-section pt-50 px-30 position-relative">
                    ...
                    <div class="qr-code mx-auto  position-relative">
                        <div class="d-flex qr-code-box flex-sm-row flex-column align-items-center"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <div class="qr-code-img text-center" id="qr-code-eighteen">
                                 @php
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!qrCodeEighteen || !link) return;

        const img = qrCodeEighteen.querySelector("img");
