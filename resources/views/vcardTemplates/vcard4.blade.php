...
<body>
    <svg width="0" height="0" style="position: absolute;">
        <defs>
            <linearGradient id="vcard4-icon-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    <div class="container p-0">
        ...
        <div
                    ...
                    <div class="px-4 pt-5 pb-4">
                        ...
                        <div class="qr-code d-block mx-auto position-relative px-5 pt-5 pb-3">
                            <img src="{{ $vcard->profile_url }}"
                                ...
                                loading="lazy" />
                            <div class="d-flex justify-content-center pt-7" id="qr-code-four">
                                @php
                                                    ...
                                                    <div class="gallery-profile">
                                                        ...
                                                        @else
                                                            <iframe
                                                                ...
                                                                class="w-100" height="230" allowfullscreen>
                                                            </iframe>
                                                        @endif
                                                    </div>
                                                </div>
            ...
            <div class="vcard__contact-us">
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    <div class="px-4 mb-8 mt-8 inquries">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (!qrCodeFour || !link) return;

                const img = qrCodeFour.querySelector("img");
