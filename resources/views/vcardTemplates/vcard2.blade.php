    ...
    <div class="container p-0">
                ...
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="vcard-two__event py-3 px-3 ms-3">
                        ...
                        @if ($vcard->alternative_phone)
                            <div class="event-details d-flex">
                                <div class="event-image">
                                    <img src="{{ asset('assets/img/vcard2/vcard2-phone.png') }}"
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="vcard-two__gallery mt-5 py-5 position-relative px-3  mt-0">
                        ...
                        @if ($groupedGallery->isNotEmpty())
                            <div class="gallery-filter-nav d-flex flex-wrap justify-content-center gap-2 mb-25px mb-2 py-2">
                        ...
                        <div class="container">
                                                ...
                                                <div class="gallery-profile">
                                                    ...
                                                    @else
                                                        <iframe
                                                            ...
                                                            class="w-100" height="225" allowfullscreen>
                                                        </iframe>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            @foreach ($groupedGallery as $categoryName => $galleryItems)
                                <div class="gallery-filter-panel"
                                    ...
                                    <div class="gallery-slider row g-3">
                                        @foreach ($galleryItems as $file)
                                            ...
                                            @endphp
                                            <div class="col-6 p-2">
                                                <div class="card gallery-card mx-auto p-3 border-0 w-100 h-100 gallery-vcard-block">
                                                    <div class="gallery-profile">
                                                        @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                                            <a href="{{ $file->gallery_image }}"
                        ...
                        <div class="container">
                            <div class="appointment p-4">
                                ...
                                <div class="row d-flex align-items-center justify-content-center mb-md-3">
                                    <div class="col-md-2">
                                        <label for="text"
                                            class="appoint-date mb-2" id="hourSection" style="display: none;">{{ __('messages.hour') }}</label>
                                    </div>
                                    <div class="col-md-10">
                                        ...
                                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                            <div class="contact-form px-sm-5">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <button type="submit"
                                                        class="contact-btn text-white mt-2 rounded d-block">{{ __('messages.contact_us.send_message') }}
                                                    </button>
                                                </div>
                                            </div>
                                        @endif
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (!qrCodeTwo || !link) return;

                const img = qrCodeTwo.querySelector("img");
