            ...
            <div class="personal-details pt-50 px-30px bg-white position-relative"
                ...
                <div class="row position-relative row-gap-16px">
                    ...
                    @if ($vcard->alternative_email)
                        <div class="col-sm-6">
                            <a href="mailto:{{ $vcard->alternative_email }}" class="text-decoration-none contact-box">
                                <div class="box-1">
                                    <div class="icon1 d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="18"
                                            viewBox="0 0 22 18" fill="none">
                    ...
                    @if ($vcard->phone)
                        <div class="col-sm-6">
                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                class="text-decoration-none contact-box">
                                <div class="box-1">
                                    <div class="icon1 d-flex align-items-center justify-content-center">
                    ...
                    @if ($vcard->dob)
                        <div class="col-sm-6">
                            <a href="#" class="text-decoration-none contact-box">
                                <div class="box-1">
                                    <div class="icon1 d-flex align-items-center justify-content-center">
                                        @if($vcard->dob_icon)
                                            <i class="dob-icon {{ $vcard->dob_icon }}"></i>
                                        @else
                                        ...
                                        <div
                                            ...
                                            <div class="gallery-img">
                                                ...
                                                @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                    <div class="audio-container h-100 w-100">
