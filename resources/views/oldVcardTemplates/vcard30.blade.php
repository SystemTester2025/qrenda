    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section px-40 @if ($vcard->cover_type == 2) profile-margin @endif ">
                ...
                @endif
                {{-- description --}}
                <div class="text-gray-100 fs-14 text-center profile-desc">
                    <p class="text-gray-100 mb-0 fs-14 text-sm-start text-center">
                        {!! $vcard->description !!}
                    </p>
                </div>
                {{-- end description --}}
                    ...
                    @if ($vcard->location)
                        <div class="col-sm-6 d-flex">
                            <div class="contact-box d-flex flex-sm-column flex-row align-items-center gap-2 w-100">
                                ...
                                <div class="contact-desc">
                                    <p class="mb-0 text-primary fw-5 text-break">{!! ucwords($vcard->location) !!}</p>
                                </div>
                            </div>
                        </div>
                    @endif
                                            ...
                                            <div class="text-light">
                                                <p class="blog-desc fs-14 mb-0">
                                                  ...
                                                  <div class="mt-1 d-flex align-items-center justify-content-end"
                                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                                    <a href=""
                                                        class="d-inline-flex align-items-center justify-content-end gap-2 fs-12 read-more text-white">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section px-40 pt-30">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!qrCodeThirty || !link) return;

        const img = qrCodeThirty.querySelector("img");
