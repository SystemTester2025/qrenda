...
<body>
    ...
    <div class="main-section position-relative m-auto">
                ...
                <div class="language pt-3 me-2">
                    <ul class="text-decoration-none">
                        <li class="dropdown1 dropdown lang-list">
                            <a class="dropdown-toggle lang-head text-decoration-none fs-14" data-toggle="dropdown"
        ...
        @if(!empty($vcard->email) || !empty($vcard->alternative_email || !empty($vcard->phone) || !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
            <div class="personal-details position-relative px-30px pt-60px" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div class="row position-relative row-gap-20">
                    @if ($vcard->email)
                        <div class="col-sm-6">
                            <a href="mailto:{{ $vcard->email }}" class="text-decoration-none bg-white d-flex h-100 w-100 p-2">
                    ...
                    @if ($vcard->alternative_email)
                        <div class="col-sm-6">
                            <a href="mailto:{{ $vcard->alternative_email }}" class="text-decoration-none bg-white d-flex h-100 w-100 p-2">
                                <div class="box-1 d-flex align-items-center gap-15">
                                    <div class="icon1 d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="18"
                                            viewBox="0 0 22 18" fill="none">
                    ...
                    @if ($vcard->phone)
                        <div class="col-sm-6">
                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-decoration-none bg-white d-flex h-100 w-100 p-2">
                                <div class="box-1 d-flex align-items-center gap-15">
                                    <div class="icon1 d-flex align-items-center justify-content-center">
                    ...
                    @if ($vcard->alternative_phone)
                        <div class="col-sm-6">
                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->alternative_phone }}"
                                class="text-decoration-none bg-white d-flex h-100 w-100 p-2">
                                <div class="box-1 d-flex align-items-center gap-15">
                                    <div class="icon1 d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                            viewBox="0 0 22 22" fill="none">
                    ...
                    @if ($vcard->dob)
                        <div class="col-sm-6">
                            <a href="#" class="text-decoration-none bg-white d-flex h-100 w-100 p-2">
                                <div class="box-1 d-flex align-items-center gap-15">
                                    <div class="icon1 d-flex align-items-center justify-content-center">
                                        @if($vcard->dob_icon)
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pb-60px position-relative  pt-60px">
                        ...
                        @if ($groupedGallery->isNotEmpty())
                            <div class="gallery-filter-nav d-flex flex-wrap justify-content-center gap-2 mb-25px mb-2 pb-3">
                                            ...
                                            <div class="gallery-img">
                                                @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                                    <a href="{{ $file->gallery_image }}"
                                                        data-lightbox="gallery-images-all"><img
                                                ...
                                                @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                    <div class="audio-container h-100">
                    ...
                    <div class="service-section pb-60px position-relative">
                        ...
                        @else
                            <div class="row services-grid-view px-4">
                                @foreach ($vcard->services as $service)
                                    <div class="col-6 mb-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <div class="service-card card mb-4">
                                            <div class="card-img sevice-img me-4">
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    class="{{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                    target="{{ $service->service_url ? '_blank' : '' }}">
                                                    <img src="{{ $service->service_icon }}" alt="branding"
                                            ...
                                            <div class="card-body w-100 d-flex flex-column justify-content-between @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-3 @endif">
                                                <div>
    ...
    <script>
        ...
        $(document).on("click", ".audio-container", function (e) {
            if ($(e.target).closest("audio").length) return;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!qrCodeThirtyfive || !link) return;

            const img = qrCodeThirtyfive.querySelector("img");
