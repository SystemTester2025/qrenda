    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section px-40 @if ($vcard->cover_type == 2) profile-margin @endif">
                ...
                @endif
                <div class="text-gray-100 profile-desc fs-14 text-sm-start text-center pt-30">
                    {!! $vcard->description !!}
                </div>
            </div>
            {{-- social icons --}}
              @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media-section px-40 pt-30">
                        ...
                        @if ($vcard->location)
                            <div class="col-sm-6 mb-40">
                                <div class="contact-box d-flex align-items-center h-100">
                                    ...
                                    <div class="contact-desc">
                                        <p class="mb-0 text-white fw-5 text-break"> {!! ucwords($vcard->location) !!}</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                                        ...
                                        <div class="gallery-img">
                                            @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                                <a href="{{ $file->gallery_image }}"
                                                    data-lightbox="gallery-images-all h1"><img
                                    ...
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body text-start d-flex flex-column">
                                            ...
                                            <p class="text-white blog-desc fw-5 fs-14 mb-0">
                                             ...
                                             <a href="{{ $vcardBlogUrl }}"
                                                class="d-inline-flex align-items-center justify-content-end gap-2 read-more text-primary mt-2">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!qrCodeTwentynine || !link) return;

        const img = qrCodeTwentynine.querySelector("img");
