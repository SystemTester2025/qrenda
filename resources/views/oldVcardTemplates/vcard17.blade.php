                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section mt-4 px-sm-0">
                        ...
                        @if ($groupedGallery->isNotEmpty())
                            <div class="gallery-filter-nav d-flex flex-wrap justify-content-center gap-2 mb-25px mb-2 pb-2 pt-3">
                                    ...
                                    <div class="slide">
                                        <div class="gallery-img">
                                            ...
                                            @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                <div class="audio-container h-100 bg-white rounded-20px">
                                            ...
                                            @else
                                                <iframe
                                                    ...
                                                    class="w-100 h-100 bg-white rounded-20px" allowfullscreen>
                                                </iframe>
                                            @endif
                                        </div>
                                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!qrCodeSeventeen || !link) return;

        const img = qrCodeSeventeen.querySelector("img");
