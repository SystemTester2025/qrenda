                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        ...
                                        <div class="contact-desc">
                                            <p class="mb-0 text-black fw-5 text-break">{!! ucwords($vcard->location) !!}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="">
                                    <div class="product-card card">
                                        ...
                                        <div class="product-desc card-body p-3 text-start">
                                            ...
                                            <div class="d-flex justify-content-between mt-2 product-info align-items-center">
                            ...
                            @foreach ($vcard->blogs as $blog)
                                ...
                                <div>
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body p-0 px-2 pb-3 d-flex flex-column">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!qrCodeTwentyeight || !link) return;

        const img = qrCodeTwentyeight.querySelector("img");
