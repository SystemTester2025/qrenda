...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class=" d-flex gap-4 flex-column px-30 position-relative">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section pt-40 px-30 position-relative">
                        ...
                        <div class="row row-gap-20px d-flex">
                            @if ($vcard->email)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100 justify-content-center">
                                        <div
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        ...
                                        <div class="contact-desc">
                                            <p class="mb-0 text-dark fw-5 text-break">{!! ucwords($vcard->location) !!}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                    ...
                    <div class="our-services-section pt-30 px-30">
                        ...
                        <div class="services">
                            @if ($vcard->services_slider_view)
                                <div class="row services-slider-view row-gap-20px service-slider">
                                        ...
                                        <div class="gallery-img">
                                            @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                                <a href="{{ $file->gallery_image }}"
                                                    ...
                                                    data-lightbox="gallery-images-all"><img src="{{ $file->gallery_image }}"
                                        ...
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="product-card card">
                                                ...
                                                <div class="product-desc d-flex flex-column justify-content-between">
                                                    ...
                                                    <div class="d-flex justify-content-between mt-2 product-info gap-1">
                                    ...
                                    <div class="px-30">
                                        <div class="blog-card card flex-column gap-4">
                                            ...
                                            <div class="card-body p-0 text-start">
                                                <h2 class="fs-18 fw-5">{{ $blog->title }}</h2>
                                                ...
                                                <div class="mt-1 d-flex align-items-center justify-content-end"
                                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                                    <a href=""
                                                        class="d-inline-flex align-items-center justify-content-end gap-2 fs-12 read-more">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!qrCodeThirtyone || !link) return;

        const img = qrCodeThirtyone.querySelector("img");
