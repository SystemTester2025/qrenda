            ...
            <div class="mb-30">
                ...
                <div>
                    <div class="form-check mb-2">
                        <input class="form-check-input {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'float-end' : '' }}" type="radio" name="flexRadioDefault" id="flexRadioDefault1"
                            wire:model.live="dateFilter" value="3_days" />
                        <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="flexRadioDefault1">
                    ...
                    <div class="form-check mb-2">
                        ...
                        <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="flexRadioDefault2">
                    ...
                    <div class="form-check mb-2">
                        ...
                        <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="flexRadioDefault3">
                    ...
                    <div class="form-check mb-2">
                        ...
                        <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="flexRadioDefault4">
                    ...
                    <div class="form-check mb-2">
                        ...
                        <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="flexRadioDefault5">
    ...
    <div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="filterOffcanvas" aria-labelledby="filterOffcanvasLabel" wire:ignore.self>
        ...
        <div class="offcanvas-body">
            <div class="items-tabs p-0">
                ...
                <div class="mb-30">
                    <div class="heading-text mb-4 border-none">
                        <h3> {{ __('messages.whatsapp_stores_templates.date_posted') }}</h3>
                    </div>
                    <div>
                        <div class="form-check mb-2" wire:key="mobile-date-3-days">
                            <input class="form-check-input {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'float-end' : '' }}" type="radio" name="mobile-flexRadioDefault" id="mobile-flexRadioDefault1"
                                wire:model.live="dateFilter" value="3_days" />
                            <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="mobile-flexRadioDefault1">
                                3 {{ __('messages.whatsapp_stores_templates.days_ago') }}
                            </label>
                        </div>
                        <div class="form-check mb-2" wire:key="mobile-date-1-week">
                            <input class="form-check-input {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'float-end' : '' }}" type="radio" wire:model.live="dateFilter" value="1_week"
                                name="mobile-flexRadioDefault" id="mobile-flexRadioDefault2" />
                            <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="mobile-flexRadioDefault2">
                                1 {{ __('messages.whatsapp_stores_templates.week_ago') }}
                            </label>
                        </div>
                        <div class="form-check mb-2" wire:key="mobile-date-1-month">
                            <input class="form-check-input {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'float-end' : '' }}" type="radio" wire:model.live="dateFilter" value="1_month"
                                name="mobile-flexRadioDefault" id="mobile-flexRadioDefault3" />
                            <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="mobile-flexRadioDefault3">
                                1 {{ __('messages.whatsapp_stores_templates.month_ago') }}
                            </label>
                        </div>
                        <div class="form-check mb-2" wire:key="mobile-date-6-months">
                            <input class="form-check-input {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'float-end' : '' }}" type="radio" wire:model.live="dateFilter" value="6_months"
                                name="mobile-flexRadioDefault" id="mobile-flexRadioDefault4" />
                            <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="mobile-flexRadioDefault4">
                                6 {{ __('messages.whatsapp_stores_templates.months_ago') }}
                            </label>
                        </div>
                        <div class="form-check mb-2" wire:key="mobile-date-1-year">
                            <input class="form-check-input {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'float-end' : '' }}" type="radio" wire:model.live="dateFilter" value="1_year"
                                name="mobile-flexRadioDefault" id="mobile-flexRadioDefault5" />
                            <label class="form-check-label fs-16 fw-5 {{ app()->getLocale() == 'ar' || app()->getLocale() == 'fa' ? 'me-4' : '' }}" for="mobile-flexRadioDefault5">
                                1 {{ __('messages.whatsapp_stores_templates.year_ago') }}
                            </label>
                        </div>
                    </div>
                ...
                <div class="mb-30">
                    <div class="heading-text mb-4">
                        <h3> {{ __('messages.whatsapp_stores_templates.search_price_range') }}</h3>
                    </div>
                    <div>
