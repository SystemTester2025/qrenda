        ...
        <div class="q-form-row">
            ...
            @if (getSuperAdminSettingValue('phone_number_required'))
                <div class="q-input-group q-form-col">
                    ...
                    {{ Form::tel('contact', old('contact'), ['class' => 'form-control text-start', 'placeholder' => __('messages.form.contact'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'id' => 'phoneNumber']) }}
