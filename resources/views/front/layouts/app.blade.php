...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Sora:wght@400;600;700;800&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link href="{{ asset('assets/css/front/redesign.css') }}" rel="stylesheet" type="text/css">
    ...
    <script src="{{ asset('assets/js/front/redesign.js') }}"></script>
...
<body data-bs-offset="71" @yield('body-class')>
    @livewireScripts()
