...
<p>This Privacy Policy describes the Company policies and procedures on the collection, use and disclosure of Your information
    when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
<p>The Company use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and
...
<h3>Personal Data</h3>
<p>While using the Company Service, The Company may ask You to provide Us with certain personally identifiable information that can be
...
<p>When You access the Service by or through a mobile device, The Company may collect certain information automatically,
...
<p>The Company may also collect information that Your browser sends whenever You visit our Service or when You access the Service
    by or through a mobile device.</p>
<h3>Tracking Technologies and Cookies</h3>
<p>The Company use Cookies and similar tracking technologies to track the activity on the Company Service and store certain information.
    Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and
    analyze the Company Service. The technologies The Company use may include:</p>
<ul>
    ...
    <li><strong>The Companyb Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files
...
<p>The Company use both Session and Persistent Cookies for the purposes set out below:</p>
<ul>
    <li>
        <p><strong>Necessary / Essential Cookies</strong></p>
        <p>Type: Session Cookies</p>
        <p>Administered by: Us</p>
        <p>Purpose: These Cookies are essential to provide You with services available through the The Companybsite and to enable
            You to use some of its features. They help to authenticate users and prevent fraudulent use of user
            accounts. Without these Cookies, the services that You have asked for cannot be provided, and The Company only use
    ...
    <li>
        ...
        <p>Administered by: Us</p>
        <p>Purpose: These Cookies identify if users have accepted the use of cookies on the The Companybsite.</p>
    </li>
    <li>
        <p><strong>Functionality Cookies</strong></p>
        <p>Type: Persistent Cookies</p>
        <p>Administered by: Us</p>
        <p>Purpose: These Cookies allow us to remember choices You make when You use the The Companybsite, such as remembering
            your login details or language preference. The purpose of these Cookies is to provide You with a more
            personal experience and to avoid You having to re-enter your preferences every time You use the The Companybsite.</p>
    </li>
</ul>
...
<ul>
    ...
    <li>
        <p><strong>For business transfers:</strong> The Company may use Your information to evaluate or conduct a merger,
            divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of the Company
    ...
    <li>
        <p><strong>For other purposes</strong>: The Company may use Your information for other purposes, such as data analysis,
...
<ul>
    <li><strong>With Service Providers:</strong> The Company may share Your personal information with Service Providers to
        monitor and analyze the use of our Service, to contact You.
    </li>
    <li><strong>For business transfers:</strong> The Company may share or transfer Your personal information in connection with,
        or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of
        the Company business to another company.
    </li>
    <li><strong>With Affiliates:</strong> The Company may share Your information with the Company affiliates, in which case we will
        require those affiliates to honor this Privacy Policy. Affiliates include the Company parent company and any other
        subsidiaries, joint venture partners or other companies that The Company control or that are under common control with
        Us.
    </li>
    <li><strong>With business partners:</strong> The Company may share Your information with the Company business partners to offer You
    ...
    <li><strong>With Your consent</strong>: The Company may disclose Your personal information for any other purpose with Your
        consent.
    </li>
</ul>
...
<p>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy
    Policy. The Company will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for
...
<p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a
    ...
    the Company Service, or The Company are legally obligated to retain this data for longer time periods.</p>
...
<p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. The Company will
...
<p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet,
    or method of electronic storage is 100% secure. While The Company strive to use commercially acceptable means to protect Your
    Personal Data, The Company cannot guarantee its absolute security.</p>
<h1>Children's Privacy</h1>
<p>the Company Service does not address anyone under the age of 13. The Company do not knowingly collect personally identifiable
    information from anyone under the age of 13. If You are a parent or guardian and You are aware that Your child has
    provided Us with Personal Data, please contact Us. If The Company become aware that The Company have collected Personal Data from
    anyone under the age of 13 without verification of parental consent, The Company take steps to remove that information from
    the Company servers.</p>
<p>If The Company need to rely on consent as a legal basis for processing Your information and Your country requires consent from
    a parent, The Company may require Your parent's consent before The Company collect and use that information.</p>
<h1>Links to Other The Companybsites</h1>
<p>the Company Service may contain links to other websites that are not operated by Us. If You click on a third party link, You
    will be directed to that third party's site. The Company strongly advise You to review the Privacy Policy of every site You
    visit.</p>
<p>The Company have no control over and assume no responsibility for the content, privacy policies or practices of any third
    party sites or services.</p>
<h1>Changes to this Privacy Policy</h1>
<p>The Company may update the Company Privacy Policy from time to time. The Company will notify You of any changes by posting the new Privacy
    Policy on this page.</p>
<p>The Company will let You know via email and/or a prominent notice on the Company Service, prior to the change becoming effective and
