...
<p>Please read these terms and conditions carefully before using the Company Service.</p>
...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;The Company&quot;, &quot;Us&quot; or
            &quot;the Company&quot; in this Agreement) refers to My Site.</p>
    </li>
    <li>
    ...
    <li>
        <p><strong>Service</strong> refers to the The Companybsite.</p>
    </li>
    <li>
    ...
    <li>
        <p><strong>The Companybsite</strong> refers to My Site, accessible from <a href="{{ url('/') }}"
...
<p>Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy
    Policy of the Company. the Company Privacy Policy describes the Company policies and procedures on the collection, use and
    disclosure of Your personal information when You use the Application or the The Companybsite and tells You about Your privacy
    rights and how the law protects You. Please read the Company Privacy Policy carefully before using the Company Service.</p>
<h1>Links to Other The Companybsites</h1>
<p>the Company Service may contain links to third-party web sites or services that are not owned or controlled by the
    Company.</p>
<p>The Company has no control over, and assumes no responsibility for, the content, privacy policies, or practices of
    ...
    services.</p>
<p>The Company strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or services
    that You visit.</p>
<h1>Termination</h1>
<p>The Company may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever,
...
<p>These Terms and Conditions may have been translated if The Company have made them available to You on our Service.
    You agree that the original English text shall prevail in the case of a dispute.</p>
<h1>Changes to These Terms and Conditions</h1>
<p>The Company reserve the right, at the Company sole discretion, to modify or replace these Terms at any time. If a revision is material
    The Company will make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. What
    constitutes a material change will be determined at the Company sole discretion.</p>
<p>By continuing to access or use the Company Service after those revisions become effective, You agree to be bound by the
